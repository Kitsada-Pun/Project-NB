...
$display_profile_pic = !empty($profile_data['profile_picture_url']) && file_exists(ltrim($profile_data['profile_picture_url'], '/')) ? $profile_data['profile_picture_url'] : '../dist/img/default_profile.png';
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <style>
        ...
        /* ========================================================== */
        /* ========= จุดที่แก้ไข: ขยับปุ่มซ้าย-ขวาออกไปด้านข้าง ========= */
        /* ========================================================== */
        .carousel-button.left {
            left: -1rem; /* ขยับปุ่มซ้ายออกไปทางซ้าย 1rem */
        }
        .carousel-button.right {
            right: -1rem; /* ขยับปุ่มขวาออกไปทางขวา 1rem */
        }
        ...
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(13, 150, 210, 0.5); }
                                        ...
                                        <div class="p-4 md:p-6 flex-grow flex flex-col justify-between">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="mt-2 flex space-x-2">
                                                    ...
                                                    <?php if ($user_id_to_view == $current_user_id): // ตรวจสอบว่าเป็นเจ้าของโปรไฟล์หรือไม่ ?>
                                                    <a href="edit_job_post.php?id=<?= $job['post_id'] ?>" class="bg-amber-500 hover:bg-amber-600 text-white px-4 py-2 rounded-lg font-medium text-sm shadow-lg transition-colors">แก้ไข</a>
                                                    <?php endif; ?>
                                                </div>
